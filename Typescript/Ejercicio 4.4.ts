...
function interrogateAnimal(animal = getRandomAnimal()) {
    animal instanceof Fish ? animal.swim(10) : Bird ? animal.fly(10) : 0; // se ve de que tipo es el animal y se ejecuta el metodo correspondiente
    // animal instanceof Fish ? animal.swim(10) : animal.fly(10):0;
